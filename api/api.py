"""
Spark ML Feature Engineering - REST API
FastAPI service for 52-spark-ml-feature-engineering
"""
...
app = FastAPI(
    title="Spark ML Feature Engineering",
    description="Production-ready API for 52-spark-ml-feature-engineering",
    version="1.0.0"
)
...
async def root():
    """Root endpoint"""
    return {
        "service": "Spark ML Feature Engineering",
        "version": "1.0.0",
        "status": "running"
    }
